...
function update(){
    ...
    if (isNaN(section_2_1_input) || section_2_1_input > 6 || section_2_1_input < 0){
        section_2_1_out = 0;
    }
    else {
    ...
    document.getElementById("section 2.1 out").value = "" + section_2_1_out.toFixed(4);
    document.getElementById("section 2.2 out").value = "" + section_2_2_out.toFixed(4);
    document.getElementById("section 2.3 out").value = "" + section_2_3_out.toFixed(4);
    document.getElementById("sum").value = "" + sum.toFixed(4);
    document.getElementById("weight 1").value = "" + weighted_1;
    document.getElementById("weight 2").value = "" + weighted_2.toFixed(4);
